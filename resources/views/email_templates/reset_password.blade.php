        ...
        <tr>
            <td>
                <table style="text-align: center; background: #fff;padding: 0 25px 30px; width: 100%;">
                        ...
                        <td>
                            <a href="#" target="_blank">
                                <img style="padding: 15px 0;width: 100%; height: 80px; object-fit: contain;"
                                    src="{{ asset('admin-assets/images/admin-2.png') }}" alt="logo-image">
                            </a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <p>We are received a request to reset the passwrod for <b>{{ env('PAGE_TITLE') }}</b> account associated with {{$msg['email']}}.You can reset your password by clicking the link<br> <a href="{{$msg['action_link']}}">Reset Password</a>
                            </p>
                        </td>
                    </tr>
