                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{url('admin/resources/download/category/add')}}">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="center sorting sorting_asc" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 48.4167px;" aria-sort="ascending"
                                                        aria-label="#: activate to sort column descending">Category Name</th>
													...
													@foreach($result as $key=>$value)
														<tr class="gradeX odd"  id="{{ $value['id'] }}">
                                                            ...
                                                            <td class="center ">
                                                                ...
                                                                <a href="{{ url('admin/resources/download/category/category-update/'.$value['id'] )}}" title="Edit Category" class="btn btn-tbl-edit">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </a>
                                                                <a title="Delete Category" onclick="return confirm('Are you sure? You want to delete this Category.')" href="{{ url('admin/resources/download/category/category-delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
...
$(document).ready(function () {
    ...
    $(document).on('change','.-change',function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ url('admin/resources/download/category/change-status') }}",
            headers: {
