	...
	<div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/important-links')}}">
                                <i class="fa fa-list"></i> Important Links List 
							</a>
                        </div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> @if(!empty($result)) Update @else Add @endif Links</h2>
					</div>
					<div class="body">
						<form id="form" action="{{ url('admin/important-links/add') }}" method="post" enctype="multipart/form-data"  autocomplete="off">
						@csrf
							...
							<div class="col-sm-6">
								<div class="form-group">
									<div class="form-line">
										...
										title="Only alphabets, numbers, and spaces are allowed." type="text" required class="form-control" placeholder="Enter Name" name="name" >
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<div class="form-line">
										<label for="inputName">Link <label class="text-danger">*</label></label>
