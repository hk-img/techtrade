      ...
      <div class="2xl:px-24 3xl:px-36 lg:pb-3  px-6 lg:px-8  w-full mx-auto flex items-center justify-between flex-col lg:flex-row relative z-10">
        <div class="flex flex-col justify-start  font-serif space-y-3 text-black lg:text-left text-left">
          ...
          <ul class="flex font-serif space-x-2 items-center lg:text-[1.125rem]">
            <li>Home</li>
            <li class="-mt-2">.</li>
            <li class="font-bold text-[#1B1E31] ">A/c Opening Process</li>
          </ul>
        </div>
        <img src="assets/img/accountbg.png" alt="" class="w-[84%] lg:w-[35%]" >
      </div>
        ...
        <div class="2xl:px-24 3xl:px-36 lg:pb-3  px-6 lg:px-8 lg:w-full mx-auto flex flex-col space-y-[22px] ">
          ...
          <div class="flex flex-wrap w-full  max-lg:gap-y-8">
            <div class="w-full pt-8">
                <div class="flex max-md:flex-col  py-16 px-8 -my-10">
                    <div class="
                        ...
                        <div class="flex rounded-[50px] flex-col p-8 relative h-full 
                            ...
                            <div class="w-full pb-3">
                                <img class="size-20 mx-auto object-contain" width="80" height="80" src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step1.webp?id=178cbe268c09d91e7742f9c25db7d198" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step1.webp?id=178cbe268c09d91e7742f9c25db7d198" alt="Planning and Research">
                            </div>
                            ...
                            <div class="flex justify-center">
                                <ul class="list-disc text-sm ml-5 flex flex-col gap-2 text-left">
                                    ...
                                    <!-- <li>Finalize feature set and technology stack</li> -->
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="
                        ...
                        <div class="flex rounded-[50px] flex-col p-8 relative h-full 
                            ...
                            ">
                            <div class="w-full pb-3">
                                <img class="size-20 mx-auto object-contain" width="80" height="80" src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step2.webp?id=79d35ebbdd1a052daf628afe710bf605" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step2.webp?id=79d35ebbdd1a052daf628afe710bf605" alt="Wireframing &amp; UI/UX Design">
                            </div>
                            ...
                            <div class="flex justify-center">
                                <ul class="list-disc text-sm ml-5 flex flex-col gap-2 text-left">
                                    ...
                                    <li>Take user feedback and refine designs</li> -->
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="
                        ...
                        <div class="flex rounded-[50px] flex-col p-8 relative h-full 
                            ...
                            ">
                            <div class="w-full pb-3">
                                <img class="size-20 mx-auto object-contain" width="80" height="80" src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step3.webp?id=f84d8b4470657d3ae67ef6401ff4eb94" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step3.webp?id=f84d8b4470657d3ae67ef6401ff4eb94" alt="Development">
                            </div>
                            ...
                            <div class="flex justify-center">
                                <ul class="list-disc text-sm ml-5 flex flex-col gap-2 text-left">
                                    ...
                                    <li>Some platforms may also require you to upload a government-issued ID for identity verification.
                                    </li>
                                    <!-- <li>Implement AI-based matchmaking algorithms</li>
                                    <li>Ensure real-time chat and notification functionality</li> -->
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="
                        ...
                        <div class="flex rounded-[50px] flex-col p-8 relative h-full 
                            ...
                            ">
                            <div class="w-full pb-3">
                                <img class="size-20 mx-auto object-contain" width="80" height="80" src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step4.webp?id=668a86b8f3149c30eda9d476d5b40510" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step4.webp?id=668a86b8f3149c30eda9d476d5b40510" alt="Quality Assurance">
                            </div>
                            ...
                            <div class="flex justify-center">
                                <ul class="list-disc text-sm ml-5 flex flex-col gap-2 text-left">
                                    ...
                                    <!-- <li>Fix bugs and optimize app performance</li>
                                    <li>Gather beta user feedback for improvements</li> -->
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="
                        ...
                        <div class="flex rounded-[50px] flex-col p-8 relative h-full 
                            ...
                            ">
                            <div class="w-full pb-3">
                                <img class="size-20 mx-auto object-contain" width="80" height="80" src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step5.webp?id=82dcef5b5b10eb7cd610081033d40860" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/app-step5.webp?id=82dcef5b5b10eb7cd610081033d40860" alt="Launch &amp; Maintenance">
                            </div>
                            ...
                            <div class="flex justify-center">
                                <ul class="list-disc text-sm ml-5 flex flex-col gap-2 text-left">
                                    ...
                                    <!-- <li>Roll out regular updates and new features</li>
