<?php include_once('header.php'); ?>
  ...
  <section class="w-full bg-white py-14">
    <div class="2xl:px-24 3xl:px-36 lg:pb-3 py-3 px-6 lg:px-8 w-full mx-auto flex flex-col space-y-5 lg:space-y-12 ">
      <div class="flex flex-col justify-center items-center space-y-2">
        ...
        <h1 class="text-2xl lg:text-4xl text-[#1B1E31] font-bold"><span class="text-[#C85103]">Trading</span> Holidays
          2025</h1>
      </div>
        ...
        <div class="max-w-full overflow-x-auto">
          <table class="w-full min-w-[600px] font-serif">
            ...
            <tbody class="text-sm font-medium ">
              <tr class="bg-[#F6F6F6]">
                <td class="p-5">Wednesday</td>
                <td class="p-5">26 February 2025</td>
                <td class="p-5">Mahashivratri</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>

              <tr class="">
                <td class="p-5">Friday</td>
                <td class="p-5">14 March 2025</td>
                <td class="p-5">Holi</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28 text-left">NSE BSE MCX</span>
                </td>
              </tr>
              <tr class="bg-[#F6F6F6]">
                <td class="p-5">Monday</td>
                <td class="p-5">31 March 2025 </td>
                <td class="p-5">Id-ul-Fitr (Ramadan Eid)</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              <tr class="">
                <td class="p-5">Thursday</td>
                <td class="p-5">10 April 2025</td>
                <td class="p-5">Shri Mahaveer Jayanti</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              ...
              <tr class="bg-[#F6F6F6]">
                <td class="p-5">Monday</td>
                <td class="p-5">14 April 2025</td>
                <td class="p-5">Dr. Baba Saheb Ambedkar Jayanti</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28 text-left">NSE BSE MCX</span>
                </td>
              </tr>
              <tr class="">
                <td class="p-5">Friday</td>
                <td class="p-5">18 April 2025</td>
                <td class="p-5">Good Friday </td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              <tr class="bg-[#F6F6F6]">
                <td class="p-5">Thursday</td>
                <td class="p-5">01 May 2025 </td>
                <td class="p-5">Maharashtra Day</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              <tr class="">
                ...
                <td class="p-5">07 June 2025</td>
                <td class="p-5">Bakri Id</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              <tr class="bg-[#F6F6F6]">
                <td class="p-5">Friday</td>
                <td class="p-5">15 August 2025</td>
                <td class="p-5">Independence Day</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              <tr class="">
                <td class="p-5">Wednesday</td>
                <td class="p-5">27 August 2025</td>
                <td class="p-5">Ganesh Chaturthi </td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              <tr class="bg-[#F6F6F6]">
                <td class="p-5">Thursday</td>
                <td class="p-5">02 October 2025</td>
                <td class="p-5">Mahatma Gandhi Jayanti/Dussehra</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              <tr class="">
                ...
                <td class="p-5">21 October 2025</td>
                <td class="p-5">Diwali Laxmi Pujan* </td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28 text-left">NSE BSE MCX</span>
              ...
              <tr class="bg-[#F6F6F6]">
                <td class="p-5">Wednesday </td>
                <td class="p-5">22 October 2025</td>
                <td class="p-5">Diwali-Balipratipada</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28 text-left">NSE BSE MCX</span>
                </td>
              </tr>
              <tr class="">
                <td class="p-5">Wednesday</td>
                <td class="p-5">05 November 2025</td>
                <td class="p-5">Prakash Gurpurb Sri Guru Nanak Dev</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
              <tr class="bg-[#F6F6F6]">
                <td class="p-5">Thursday</td>
                <td class="p-5">25 December 2025</td>
                <td class="p-5">Christmas</td>
                <td class="p-5 text-left flex justify-end">
                  <span class="w-28">NSE BSE</span>
                </td>
              </tr>
  ...
  <section class="w-full bg-white pb-14">
    <div class="2xl:px-24 3xl:px-36 lg:pb-3 py-3 px-6 lg:px-8 w-full mx-auto flex flex-col space-y-5 lg:space-y-12 ">
      <div class="flex flex-col justify-center items-center space-y-2">
        <span class="text-lg text-[#6E6E6E]">Calendar</span>
        <h1 class="text-2xl lg:text-4xl text-[#1B1E31] font-bold"><span class="text-[#C85103]">Settlement</span>
          Holidays 2025</h1>
      </div>
      <div class="w-full border rounded-lg overflow-hidden">
        <div class="max-w-full overflow-x-auto">
