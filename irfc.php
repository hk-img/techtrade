<?php include_once('header.php'); ?>
    <!-- <div class="w-full bg-[#E7EFFA] font-barlow  py-12 lg:py-0 lg:h-[4.375rem] h-auto mt-24 relative  flex   items-center justify-center">
      <div class="2xl:px-24 3xl:px-36 lg:pb-3  px-6 lg:px-8  w-full mx-auto flex items-center justify-between flex-col lg:flex-row ">
        
        <div class="flex overflow-hidden  flex-col">
          <ul class="flex gap-8 flex-row w-full overflow-x-auto   items-center">
            <li class="relative flex  group">
              <a href="javascript:;" class="flex items-center  mt-4 px-2 lg:px-1 text-black font-normal opacity-100 text-[1.125rem] duration-300 group-hover:md:text-themeColor1  lg:max-xl:text-[0.75rem]  gap-1">
                Trade & Invest
             
              </a>
             <div class="absolute top-[4.675rem]  left-0  transition-all  w-[19.125rem] shadow-lg z-10 border-[0.031rem] border-secondary bg-white/90 backdrop-blur-lg opacity-0 invisible group-hover:md:opacity-100 group-hover:md:visible duration-300 group-hover:-translate-y-3 after:absolute after:!w-full after:!-top-10 after:!h-10 after:left-0">
              <div class="grid grid-cols-2 lg:flex lg:flex-nowrap w-full gap-4  items-stretch text-[0.813rem] leading-7">
                  <div class="w-full flex flex-col   ">
                      <div class="relative group/hvr py-4 border-b">
                          <div class="flex-auto ">
                                <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                  <div class="flex items-center gap-2">
                                     
                                      <div>
                                          <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Stocks</span>
                                      </div>
                                  </div>
                                </a>
                          </div>
                        ...
                        <div class="flex-auto ">
                              <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span class="font-bold text-[1.125rem] font-serif duration-300 group-hover/hvr:md:text-themeColor1">Indices</span>
                                    </div>
                                </div>
                              </a>
                        </div>
                      ...
                      <div class="flex-auto ">
                            <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                              <div class="flex items-center gap-2">
                                  ...
                                  <div>
                                      <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">NFO</span>
                                  </div>
                              </div>
                            </a>
                      </div>
                    ...
                    <div class="flex-auto ">
                          <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">ETF</span>
                                </div>
                            </div>
                          </a>
                    </div>
                </div>
                <div class="relative py-4 group/hvr">
                  <div class="flex-auto ">
                        <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                          <div class="flex items-center gap-2">
                             
                              <div>
                                  <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Upcoming IPO</span>
                              </div>
                          </div>
                        </a>
                  </div>
                          ...
                          <div class="flex-auto ">
                                <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                  <div class="flex items-center gap-2">
                                      ...
                                      <div>
                                          <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">SIP Calculator</span>
                                      </div>
                                  </div>
                                </a>
                          </div>
                        ...
                        <div class="flex-auto ">
                              <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span class="font-bold text-[1.125rem] font-serif duration-300 group-hover/hvr:md:text-themeColor1">Mutual Funds</span>
                                    </div>
                                </div>
                              </a>
                        </div>
                      ...
                      <div class="flex-auto ">
                            <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                              <div class="flex items-center gap-2">
                                  ...
                                  <div>
                                      <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">AMCs</span>
                                  </div>
                              </div>
                            </a>
                      </div>
                    ...
                    <div class="flex-auto ">
                          <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Types of Mutual Funds</span>
                                </div>
                            </div>
                          </a>
                    </div>
                  ...
                  <div class="flex-auto ">
                        <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                          <div class="flex items-center gap-2">
                              ...
                              <div>
                                  <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Mutual Funds Screener</span>
                              </div>
                          </div>
                        </a>
                  </div>
                          ...
                          <div class="flex-auto ">
                                <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                  <div class="flex items-center gap-2">
                                      ...
                                      <div>
                                          <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Live Blog</span>
                                      </div>
                                  </div>
                                </a>
                          </div>
                        ...
                        <div class="flex-auto ">
                              <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span class="font-bold text-[1.125rem] font-serif duration-300 group-hover/hvr:md:text-themeColor1">Knowledge Center</span>
                                    </div>
                                </div>
                              </a>
                        </div>
                      ...
                      <div class="flex-auto ">
                            <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                              <div class="flex items-center gap-2">
                                  ...
                                  <div>
                                      <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Smart  Money</span>
                                  </div>
                              </div>
                            </a>
                      </div>
                    ...
                    <div class="flex-auto ">
                          <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Finance Wiki</span>
                                </div>
                            </div>
                          </a>
                    </div>
                          ...
                          <div class="flex-auto ">
                                <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                  <div class="flex items-center gap-2">
                                      ...
                                      <div>
                                          <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Angel One Supper App</span>
                                      </div>
                                  </div>
                                </a>
                          </div>
                        ...
                        <div class="flex-auto ">
                              <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span class="font-bold text-[1.125rem] font-serif duration-300 group-hover/hvr:md:text-themeColor1">Angel One Trade</span>
                                    </div>
                                </div>
                              </a>
                        </div>
                      ...
                      <div class="flex-auto ">
                            <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                              <div class="flex items-center gap-2">
                                  ...
                                  <div>
                                      <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Smart API</span>
                                  </div>
                              </div>
                            </a>
                      </div>
                          ...
                          <div class="flex-auto ">
                                <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                  <div class="flex items-center gap-2">
                                      ...
                                      <div>
                                          <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Authorised Person</span>
                                      </div>
                                  </div>
                                </a>
                          </div>
                        ...
                        <div class="flex-auto ">
                              <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span class="font-bold text-[1.125rem] font-serif duration-300 group-hover/hvr:md:text-themeColor1">Mutual Funds Distributor</span>
                                    </div>
                                </div>
                              </a>
                        </div>
                      ...
                      <div class="flex-auto ">
                            <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                              <div class="flex items-center gap-2">
                                  ...
                                  <div>
                                      <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Authorised Person Locator</span>
                                  </div>
                              </div>
                            </a>
                      </div>
                          ...
                          <div class="flex-auto ">
                                <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                  <div class="flex items-center gap-2">
                                      ...
                                      <div>
                                          <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">User Manual</span>
                                      </div>
                                  </div>
                                </a>
                          </div>
                        ...
                        <div class="flex-auto ">
                              <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span class="font-bold text-[1.125rem] font-serif duration-300 group-hover/hvr:md:text-themeColor1">Read FAQs</span>
                                    </div>
                                </div>
                              </a>
                        </div>
                      ...
                      <div class="flex-auto ">
                            <a href="javascript:;" class="text-[1.125rem] text-black font-semibold flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md ">
                              <div class="flex items-center gap-2">
                                  ...
                                  <div>
                                      <span class="font-bold  font-serif duration-300 group-hover/hvr:md:text-themeColor1">Contact Us</span>
                                  </div>
                              </div>
                            </a>
                      </div>
            ...
            <li class="relative group">
              <a href="javascript:;" class="flex items-center mt-4 px-2 lg:px-1 text-black font-normal opacity-100 text-[1.125rem] duration-300 group-hover:md:text-themeColor1 uppercase lg:max-xl:text-[0.75rem]  gap-1">
