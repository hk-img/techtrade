    ...
    <section class="w-full py-12 relative bg-white" >
          <div class="2xl:px-24 lg:3xl:px-36 lg:pb-3    lg:w-full mx-auto">
            ...
            <div class="flex flex-col space-y-3 justify-center  items-center ">
              ...
              <h2 class="lg:text-4xl text-xl font-heading text-black font-bold text-center"><span class="lg:text-4xl text-xl font-bold text-[#C85103]">We're</span>  Here To Help - Get In Touch <br>Us Today  </h2>
         </div>
          </div>
    </section>
         ...
         <section class="w-full pb-8 relative bg-white">
                  ...
                  <div class="w-full py-12 flex space-y-2 flex-col">
                    <div class="flex rounded-lg shadow space-x-3 shadow-[#9C9292] px-4 py-5 h-32 flex-row">
                      ...
                      <div class="flex w-80  flex-col">
                        ...
                        <h2 class="text-base font-serif text-[#525566] font-medium">F-116, City Plaza, Space Cinema, Bani Park,Jaipur, Rajasthan - 302016</h2>
                      </div>
                    ...
                    <div class="flex rounded-lg shadow space-x-3 shadow-[#9C9292] px-4 py-5 h-32 flex-row">
                      ...
                      <div class="flex w-80  flex-col">
                        ...
                        <h2 class="text-base font-serif text-[#525566] font-medium">U-6 Krishna Apartment, Hathi Babu Marg, Bani Park,Jaipur, Rajasthan- 302016, India</h2>
                      </div>
                    </div>
                    <div class="flex rounded-lg shadow space-x-3 shadow-[#9C9292] px-4  py-5 h-32 flex-row items-center">
                      ...
                      <div class="flex w-80  flex-col">
                        ...
                        <h2 class="text-base font-serif text-[#525566] font-medium">+91-7792022561</h2>
                      </div>
                    ...
                    <div class="flex rounded-lg shadow space-x-3 shadow-[#9C9292] px-4 py-5 h-32 flex-row items-center">
                      ...
                      <div class="flex w-80 text-   flex-col">
                        ...
                        <h2 class="text-base font-serif text-[#525566] font-medium">info@techtrade.in</h2>
                      </div>
                    </div> 
                  </div> 
              </div>
        ...
        </section><section class="w-full bg-white py-10">
          <div class="2xl:px-24 3xl:px-36 lg:pb-3 py-3 px-6 lg:px-8 w-full mx-auto flex flex-col space-y-8 ">
              <div class="">
                  <h1 class="text-2xl font-heading font-bold"><span class="text-orange-500">Investor</span> Complaint Escalation Matrix
                  </h1>
              </div>
          ...
          <section class="w-full bg-white py-8">
            <div class="2xl:px-24 3xl:px-36 lg:pb-3 py-3 px-6 lg:px-8 w-full mx-auto flex flex-col space-y-8 ">
              <div class="">
                <h1 class="text-2xl font-heading font-bold"><span class="text-orange-500">Stock </span> Broker Details
                </h1>
              </div>  
          ...
          <tbody class="text-sm  ">
            <tr class="bg-[#F6F6F6] font-serif">
              <td class="p-5" >Sanchit Financial & <br> Management Services Ltd.</td>
              <td class="p-5">INZ000295835</td>
              <td class="p-5">U-6 Krishna Apartment, <br> Hathi Babu Marg, Bani Park,<br>Jaipur, Rajasthan- 302016, <br> India</td>
              <td class="p-5" >Registered Office</td>
              <td class="p-5" >7792022561</td>
              <td class="p-5" >info@techtrade.in
                </td>
            </tr>
            </tbody>
            </table>
            ...
            <section class="w-full bg-white py-8">
              <div class="2xl:px-24 3xl:px-36 lg:pb-3 py-3 px-6 lg:px-8 w-full mx-auto flex flex-col space-y-8 ">
                <div class="">
                  <h1 class="text-2xl font-heading font-bold"><span class="text-orange-500">Details </span>  of Key People
                  </h1>
                </div>  
