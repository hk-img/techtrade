		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					...
					<div class="body">
						<form id="form" action="{{ route('admin.settings.user.add') }}" method="post"  autocomplete="off">
						@csrf
							...
							<div class="col-sm-6">
								<div class="form-group">
									<div class="form-line">
										...
										<input  value="@if(!empty($result)){{ $result['title'] }}@endif" type="text" required class="form-control" placeholder="Enter Username" name="username" maxlength="8">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<div class="form-line">
										...
										<input  value="@if(!empty($result)){{ $result['title'] }}@endif" type="text" required class="form-control" placeholder="Enter Mobile Number" name="mobile" oninput="this.value = this.value.replace(/[^0-9.]+/, '').replace(/(\..*)\./, '$1');" maxlength="10">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<div class="form-line">
										...
										<input  value="@if(!empty($result)){{ $result['title'] }}@endif" type="text" required class="form-control" placeholder="Enter Email" name="email" >
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<div class="form-line">
										...
										<input  value="@if(!empty($result)){{ $result['title'] }}@endif" type="text" required class="form-control" placeholder="Enter Password" name="password">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<div class="form-line">
										...
										<textarea class="form-control"  name="address" placeholder="Enter Address">@if(!empty($result)){{ $result['description'] }}@endif</textarea>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-group">
									<div class="form-line">
										...
										<select class="form-control category" name="role" required>
											...
											<option value="1" @if(!empty($result['discount_type']) && $result['discount_type'] == 1) selected @endif>Super User</option>
											<option value="2" @if(!empty($result['discount_type']) && $result['discount_type'] == 2) selected @endif>Sub User</option>
											<option value="3" @if(!empty($result['discount_type']) && $result['discount_type'] == 2) selected @endif>User</option>
											<option value="4" @if(!empty($result['discount_type']) && $result['discount_type'] == 2) selected @endif>Manager</option>
										</select>
									</div>
								</div>
							</div>
