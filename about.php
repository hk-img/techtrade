  ...
  <section class="w-full py-[120px] relative">
    <div class="2xl:px-24 3xl:px-36 lg:pb-3 px-6 lg:px-8  flex flex-col space-y-5">
      <div class="flex flex-col lg:flex-row">
        ...
        <div
          class="lg:w-[169px] left-0 2xl:bottom-40 hidden lg:h-[38px] absolute bg-[#C85103E5] z-10 lg:bottom-[110px]">
        </div>
    ...
    <div class="flex lg:flex-row flex-col space-x-0 space-y-4 lg:space-y-0 lg:space-x-[100px] py-[60px] justify-between items-stretch">
      <div class="flex flex-col shadow py-4 lg:px-4 px-4 items-center rounded-[25px] shadow-[#0000001A] lg:w-full lg:h-auto">
          ...
          <div class="lg:text-base text-sm font-medium font-serif text-[#666666] py-2">Driven by a deep understanding of financial markets and a strong enthusiasm for trading, Praveen Agrawal has been actively involved in jobbing and arbitrage since 2004, utilizing leading trading platforms such as <b>NCDEX,</b> <b>MCX,</b> <b>NSE,</b> and <b>BSE.</b>
            ...
            However, his vision extended beyond trading alone. He aspired to <b>create employment opportunities</b> for individuals passionate about the financial sector, equipping them with the knowledge and skills to succeed. His commitment to <b>mentorship and entrepreneurship</b> development has helped many professionals build careers in <b>equity and commodity markets.</b><br>
      ...
      <div class="flex flex-col shadow  py-4 lg:px-4 px-4 items-center rounded-[25px] shadow-[#0000001A] lg:w-full lg:h-auto">
        ...
        <div class="lg:text-base text-sm font-medium font-serif text-[#666666] py-2">As the Director of Sanchit Financial, Mrs. Sharmila Agrawal has been a driving force behind the company’s vision and growth. Her leadership and dedication have played a crucial role in shaping the firm’s values and commitment to excellence. With her strategic guidance, Sanchit Financial has strengthened its position as a trusted and respected name in the financial industry.
        <br>
        </div>
      </div>
      </div>
        ...
        <div class="swiper mySwiper2">
          <div class="swiper-wrapper">
            <div class="swiper-slide bg-white p-7 flex items-center justify-center ">
              ...
              <div
                class="flex rounded-[10px] border border-[#DBDBDB] py-6 h-auto px-9 shadow-[#0000001A]   shadow flex-col">
            ...
            <div class="swiper-slide bg-white p-7  flex items-center justify-center ">
              ...
              <div
                class="flex rounded-[10px] border border-[#DBDBDB] py-6 lg:h-auto px-9 shadow-[#0000001A]   shadow flex-col">
                <div class="flex lg:w-auto space-x-2 lg:h-auto  flex-row">
                  ...
                  <div class="flex flex-col">
                    <div class="text-[22px] font-semibold font-heading text-[#1B1E31]">William Brooks
                    </div>
