...
<section class="w-full py-[80px] relative bg-white">
    <div class="2xl:px-24 3xl:px-36 lg:pb-3 px-6 lg:px-8 lg:w-full mx-auto flex flex-col space-y-[14px]">
        <div>
            <div class="font-heading text-2xl font-bold text-[#1B1E31]"><a href="investor-charter">Investor Charter</a></div>
        </div>

        <div class="grid grid-cols-1 gap-2 lg:grid-cols-3">
            <div class="flex space-y-3 flex-col">
                <a href="https://drive.google.com/file/d/19rI38Gs7_TNEFrhHMy7JEJrHaYXCXpeF/view?usp=sharing" target="_blank">
            ...
            <div class="flex space-y-3 flex-col">
                <a href="https://drive.google.com/file/d/1Y64lBIw_uX2UKJH8dI-X3-V3H_07XNun/view?usp=sharing" target="_blank">
                    <div class="flex rounded-md border w-full px-4 py-4 border-[#E6E6E6] justify-between items-center">
                        <div class="flex space-x-2">
                            <div class="w-9 h-9 overflow-hidden">
                                <img src="assets/img/pdf.png" alt="" class="w-full h-full" />
            ...
            <div class="flex space-y-3 flex-col">
                <a href="https://drive.google.com/file/d/139WZL9433TUqlj7EPELet9KB4NtCU7t7/view?usp=sharing" target="_blank">
                    <div class="flex rounded-md border w-full px-4 py-4 border-[#E6E6E6] justify-between items-center">
                        <div class="flex space-x-2">
                            <div class="w-9 h-9 overflow-hidden">
                                <img src="assets/img/pdf.png" alt="" class="w-full h-full" />
            ...
            <div class="flex space-y-3 flex-col">
                <a href="https://drive.google.com/file/d/1SrGweWI8clNrlwwA3Y0EoFB-DnwTuFl1/view?usp=sharing" target="_blank">
                    <div class="flex rounded-md border w-full px-4 py-4 border-[#E6E6E6] justify-between items-center">
                        <div class="flex space-x-2">
                            <div class="w-9 h-9 overflow-hidden">
                                <img src="assets/img/pdf.png" alt="" class="w-full h-full" />
                ...
                <a href="https://drive.google.com/file/d/17nW5S-tBO7SJXniY-1fTHy5AsGJ9i6PM/view" target="_blank">
                    <div class="flex rounded-md border w-full px-4 py-4 border-[#E6E6E6] justify-between items-center">
                        <div class="flex space-x-2">
                            ...
                            <h1 class="font-semibold text-sm font-serif w-full">Due Diligence</h1>
                        </div>
                        <div class="flex space-x-2">
                            <div class="bg-[#004AAD] min-w-[31px] min-h-[30px] w-8 h-8 flex justify-center items-center rounded-lg">
                                <span class="text-white">
                ...
                <a href="https://drive.google.com/file/d/1cb8dsDfXzavCu5BlsJOEfyzh4bafHPKF/view" target="_blank">
                    <div class="flex rounded-md border w-full px-4 py-4 border-[#E6E6E6] justify-between items-center">
                        <div class="flex space-x-2">
                            ...
                            <h1 class="font-semibold text-sm font-serif w-full">Notifier Intimation</h1>
                        </div>
                        <div class="flex space-x-2">
                            <div class="bg-[#004AAD] min-w-[31px] min-h-[30px] w-8 h-8 flex justify-center items-center rounded-lg">
                                <span class="text-white">
                ...
                <a href="https://drive.google.com/file/d/1MEkmHB2WWL-SyZXmp8J369xplNVVsYYH/view" target="_blank">
                    <div class="flex rounded-md border w-full px-4 py-4 border-[#E6E6E6] justify-between items-center">
                        <div class="flex space-x-2">
                            ...
                            <h1 class="font-semibold text-sm font-serif w-full">NSDL-Transmission</h1>
                        </div>
                        <div class="flex space-x-2">
                            <div class="bg-[#004AAD] min-w-[31px] min-h-[30px] w-8 h-8 flex justify-center items-center rounded-lg">
                                <span class="text-white">
