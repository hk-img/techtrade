      ...
      <div class="2xl:px-24 3xl:px-36 lg:pb-3  px-6 lg:px-8  w-full mx-auto flex items-center justify-between flex-col lg:flex-row relative z-10">
        <div class="flex flex-col justify-start  font-serif space-y-3 text-black lg:text-left text-left">
          ...
          <ul class="flex font-serif space-x-2 items-center lg:text-[1.125rem]">
            <li>Home</li>
            <li class="-mt-2">.</li>
            <li class="font-bold text-[#1B1E31]">Funds Transfer</li>
          </ul>
        </div>
        <img src="assets/img/fundsbg.png" alt="" class="w-[84%] lg:w-[35%]" >
      </div>
            ...
            <div class="flex w-full min-w-[900px] py-6 space-x-4 lg:flex-row ">
              ...
              <div class="w-full sm:w-full md:w-full  lg:w-2/3 flex flex-col space-y-3">
                ...
                <div class="w-full  h-auto px-4  py-1 lg:py-5 rounded-md border border-gray-300">
                  <h1 class="font-medium text-xs  lg:text-base leading-7 text-gray-800"> Virtual Bank Account No. – SANFN7( YOUR CLIENT CODE) Virtual A/c no will be combination of Prefix (SANFN7) & Suffix (Client Code). For example, your client code is CJRM1 than bank account number written as SANFN7CJRM1  </h1>
                </div>
                <div class="w-full  h-auto px-4 py-5 rounded-md border border-gray-300">
                  <h1 class="font-medium text-sm lg:text-base text-gray-800">Current Account

                  </h1>
                </div>
                <div class="w-full  h-auto px-4 py-5 rounded-md border border-gray-300">
                  <h1 class="font-medium text-sm lg:text-base text-gray-800">ASHOK MARG C SCHEME – JAIPUR, RAJASTHAN
      ...
      <section class="w-full py-[50px] mb-1 lg:h-auto overflow-hidden relative bg-white" style="background-image: url('assets/img/fundslbg.png');" >
        <div class="2xl:px-24 3xl:px-36 lg:pb-3  px-6 lg:px-8    lg:w-full mx-auto  flex flex-col space-y-[22px] ">
          ...
          <div class=" lg:space-y-0 space-y-3  space-x-0 lg:space-x-6 grid grid-cols-1 lg:grid-cols-2  ">
            ...
            <div class="flex flex-col  px-5  h-auto border border-[#D9D9D9] rounded-[10px] drop-shadow shadow-[#EAECEE1A]">
               ...
               <div class="flex flex-row justify-between ">
                ...
                <span class="w-[70px] rounded-full text-[#C85103] mt-2 flex justify-center items-center bg-[#F5F5F5] h-[70px]">            <svg stroke="currentColor" fill="none" stroke-width="2"
                  viewBox="0 0 24 24" stroke-linecap="round"
                  stroke-linejoin="round" height="3rem" width="3rem"
                  xmlns="http://www.w3.org/2000/svg"><path
                    ...
                    d="M19.875 6.27c.7 .398 1.13 1.143 1.125 1.948v7.284c0 .809 -.443 1.555 -1.158 1.948l-6.75 4.27a2.269 2.269 0 0 1 -2.184 0l-6.75 -4.27a2.225 2.225 0 0 1 -1.158 -1.948v-7.285c0 -.809 .443 -1.554 1.158 -1.947l6.75 -3.98a2.33 2.33 0 0 1 2.25 0l6.75 3.98h-.033z"></path></svg></span>
               
               </div>
                
               <div class="flex flex-col py-4 space-y-2">
                <div class="flex flex-row gap-3">
                    <span class="w-[16px] py-1 h-[15px]  text-[#3F3D56] "><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z"></path></svg></span>
                     <h1 class="font-serif lg:text-base text-sm font-medium text-[#666666]">ICICI
                    </h1>
                </div>
                <div class="flex flex-row gap-3">
                    <span class="w-[16px] py-1 h-[15px] text-[#3F3D56] "><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z"></path></svg></span>
                     <h1 class="font-serif lg:text-base text-sm font-medium text-[#666666]">000705037385
                    </h1>
                </div>
                <div class="flex flex-row gap-3">
                    <span class="w-[16px] py-1 h-[15px] text-[#3F3D56] "><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z"></path></svg></span>
                     <h1 class="font-serif lg:text-base text-sm font-medium text-[#666666]">ICIC0000007
                    </h1>
                </div>
                <div class="flex flex-row gap-3">
                    <span class="w-[16px] py-1 h-[15px] text-[#3F3D56] "><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z"></path></svg></span>
                     <h1 class="font-serif lg:text-base text-sm font-medium text-[#666666]">M/S SANCHIT FIN. & MGT. SERVICES LTD.
                    </h1>
                </div>
               </div>
          ...
          <div class="flex flex-col py-4 space-y-2">
            ...
            <div class="flex flex-row  gap-3">
                <span class="w-[16px] py-1 h-[15px] text-[#3F3D56] "><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z"></path></svg></span>
                 <h1 class="font-serif lg:text-base text-sm font-medium text-[#666666]">HDFC
                </h1>
            </div>
            <div class="flex flex-row gap-3">
                <span class="w-[16px] py-1 h-[15px] text-[#3F3D56] "><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z"></path></svg></span>
                 <h1 class="font-serif lg:text-base text-sm font-medium text-[#666666]">57500001492020
                </h1>
            </div>
            <div class="flex flex-row gap-3">
                <span class="w-[16px] py-1 h-[15px] text-[#3F3D56] "><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z"></path></svg></span>
                 <h1 class="font-serif lg:text-base text-sm font-medium text-[#666666]">HDFC0000054
                </h1>
            </div>
            <div class="flex flex-row gap-3">
                <span class="w-[16px] py-1 h-[15px] text-[#3F3D56] "><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z"></path></svg></span>
