          ...
          <div class="flex items-end">
              <ul class="lg:flex gap-2 lg:max-xl:gap-0 hidden items-center">
                  <li class="relative group">
                      <a href="{{url('about')}}" class="flex items-center px-2 lg:px-1 text-black font-semibold opacity-100 text-[0.813rem] duration-300 hover:md:text-themeColor1 uppercase lg:max-xl:text-[0.75rem]  gap-1 after:absolute after:!w-full after:!-top-10 after:!h-10  after:left-0 ">
                         About
                   ...
                   <div class="absolute top-[4.688rem] rounded-xl -left-20 transition-all max-w-[28.125rem] shadow-lg z-10 border-[0.031rem] border-secondary bg-white/90 backdrop-blur-lg opacity-0 invisible group-hover:md:opacity-100 group-hover:md:visible duration-300 group-hover:-translate-y-3 after:absolute after:!w-full after:!-top-10 after:!h-10 after:left-0">
                    <div class="grid grid-cols-2 lg:flex lg:flex-nowrap w-full gap-4 xl:p-2 items-stretch text-[0.813rem] leading-7">
                        ...
                        <div class="relative group/hvr">
                            ...
                            <div class="relative group/hvr">
                                <div class="flex-auto ">
                                      <a href="{{url('account-opening-process')}}" class="text-[0.813rem] text-black font-medium flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md group-hover/hvr:md:bg-[#f0f6ff]">
                                        <div class="flex items-center gap-2">
                                            <span class="*:size-5 *:text-themeColor1 mr-2">
                            ...
                            <div class="relative group/hvr">
                              <div class="flex-auto ">
                                  <a href="{{ url('downloads') }}" class="text-[0.813rem] text-black font-medium flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md group-hover/hvr:md:bg-[#f0f6ff] ">
                                      <div class="flex items-center gap-2">
                                          <span class="*:size-5 *:text-themeColor1 mr-2">
                            ...
                            <div class="relative group/hvr">
                              <div class="flex-auto ">
                                  <a href="{{url('investor-charter')}}" class="text-[0.813rem] text-black font-medium flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md group-hover/hvr:md:bg-[#f0f6ff] ">
                                      <div class="flex items-center gap-2">
                                          <span class="*:size-5 *:text-themeColor1 mr-2">
                            ...
                            <div class="relative group/hvr">
                              <div class="flex-auto ">
                                  <a href="{{url('holiday-calendar')}}" class="text-[0.813rem] text-black font-medium flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md group-hover/hvr:md:bg-[#f0f6ff] ">
                                      <div class="flex items-center gap-2">
                                          <span class="*:size-5 *:text-themeColor1 mr-2">
                            ...
                            <div class="relative group/hvr">
                              <div class="flex-auto ">
                                  <a href="{{url('fit-and-proper-declaration')}}" class="text-[0.813rem] text-black font-medium flex items-center duration-300 leading-tight whitespace-nowrap px-2 py-3 rounded-md group-hover/hvr:md:bg-[#f0f6ff]">
                                      <div class="flex items-center gap-2">
                                          <span class="*:size-5 *:text-themeColor1 mr-2">
                  ...
                  <li class="relative group">
                      ...
                      <div class="absolute top-[4.688rem] rounded-xl -left-[6.875rem] w-[28.75rem] shadow-lg z-10 border-[0.031rem] border-secondary bg-white/90 duration-300 backdrop-blur-lg invisible opacity-0 group-hover:md:opacity-100 group-hover:md:visible group-hover:-translate-y-3 after:absolute after:!w-full after:!-top-10 after:!h-10 after:left-0 hover:md:text-themeColor1">
                          <div class="grid  w-full gap-4 xl:p-2 items-stretch text-[0.813rem] leading-7">
                              <div class="w-full grid-cols-2 grid p-2">
                                @if(!empty($links))
                                  @foreach($links as $link)
                                    <div class="relative group/hvr">
                                      <div class="flex-auto px-2 py-2 rounded-md group-hover/hvr:md:bg-[#f0f6ff] ">
                                            <a href="{{$link->link}}" target="_blank" class="text-[0.813rem] text-black font-medium flex items-center leading-tight whitespace-nowrap lg:text-left ">
                  ...
                  <li class="relative group">
                      <a href="{{url('product')}}" class="flex items-center px-2 lg:px-1 text-black font-semibold opacity-100 text-[0.813rem] duration-300 group-hover:md:text-themeColor1 uppercase lg:max-xl:text-[0.75rem]  gap-1">
                        Products</a>
                  </li>
                  <li class="relative group">
                      ...
                      <div class="absolute top-[4.688rem] rounded-xl -left-20 transition-all max-w-[28.125rem] shadow-lg z-10 border-[0.031rem] border-secondary bg-white/90 backdrop-blur-lg opacity-0 invisible group-hover:md:opacity-100 group-hover:md:visible duration-300 group-hover:-translate-y-3 after:absolute after:!w-full after:!-top-10 after:!h-10  after:left-0">
                        <div class="grid grid-cols-2 lg:flex lg:flex-nowrap w-full gap-4 xl:p-2 items-stretch text-[0.813rem] leading-7">
                            <div class="w-full flex flex-col p-3">
                                ...
                                <div class="relative group/hvr">
                                  <div class="flex-auto ">
                                      <a href="{{url('funds-transfer')}}" class="text-[0.813rem] text-black font-medium flex items-center leading-tight rounded-md whitespace-nowrap px-2 py-3 group-hover/hvr:md:bg-[#f0f6ff]">
                                          <div class="flex items-center gap-2">
                                              <span class="*:size-5 *:text-themeColor1 mr-2">
                                                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="12.5rem" width="12.5rem" xmlns="http://www.w3.org/2000/svg"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="M12 18v-6"></path><path d="m9 15 3 3 3-3"></path></svg>
                                              </span>
                                ...
                                <div class="relative group/hvr">
                                  <div class="flex-auto ">
                                      <a href="{{url('freeze-unfreeze-trading-account')}}" class="text-[0.813rem] text-black font-medium flex items-center  leading-tight rounded-md whitespace-nowrap px-2 py-3 group-hover/hvr:md:bg-[#f0f6ff] group-hover/hvr:md:border-[#f0f6ff] ">
                                          <div class="flex items-center gap-2">
                                              <span class="*:size-5 *:text-themeColor1 mr-2">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="12.5rem" width="12.5rem" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M6 9.99h2v7H6zm8 3h2v4h-2zm-4-6h2v10h-2zM20 7V4h-2v3h-3v2h3v3h2V9h3V7zm-2 12H4V5h12V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-5h-2v5z"></path></svg>
                                              </span>
                   ...
                   <li class="relative group">
                      <a href="{{url('contact-us')}}" class="flex items-center px-2 lg:px-1 text-black font-semibold opacity-100 text-[0.813rem] duration-300 hover:md:text-themeColor1 uppercase lg:max-xl:text-[0.75rem]  gap-1 after:absolute after:!w-full after:!-top-10 after:!h-10  after:left-0 ">
                         Contact Us
                         <span class="*:size-[0.8rem]">
                          <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="12.5rem" width="12.5rem" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M6 6v2h8.59L5 17.59 6.41 19 16 9.41V18h2V6z"></path></svg>
                        </span>
                            ...
                            <div class="w-full flex flex-col p-2">
                                <div class="mb-4 relative group/hvr">
                                    <div class="flex-auto bg-[#EDEDED]/80 py-3 px-3 duration-300 rounded-md group-hover/hvr:bg-[#f0f6ff] group-hover/hvr:md:shadow-lg">
                                        <a href="{{url('investor-grievance')}}" class="flex items-center leading-tight whitespace-nowrap lg:text-left">
                                            <div class="flex items-center gap-3">
                                ...
                                <div class="mb-4 relative w-full">
                                  <div class="flex items-center gap-3 w-full *:w-1/2">
                                    <a href="{{url('careers')}}" class="group/btn text-[0.813rem] text-black font-medium px-2 py-4 border border-[#dddddd] flex items-center justify-center rounded-md leading-tight whitespace-nowrap text-center duration-300 hover:md:shadow-lg hover:md:bg-[#f0f6ff]">
                                      <span class="font-bold text-sm font-serif text-center duration-300 group-hover/btn:text-themeColor1 ">Careers</span>
                                    </a>
                                    <a href="{{url('contact-us')}}" class="group/btn text-[0.813rem] text-black font-medium px-2 py-4 border border-[#dddddd] flex items-center justify-center rounded-md leading-tight whitespace-nowrap text-center duration-300 hover:md:shadow-lg hover:md:bg-[#f0f6ff]">
